...
/* harmony import */ var _shared_mat_confirm_dialog_mat_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./shared/mat-confirm-dialog/mat-confirm-dialog.component */ "./src/app/shared/mat-confirm-dialog/mat-confirm-dialog.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _shared_material_module__WEBPACK_IMPORTED_MODULE_14__["MaterialModule"],
...
let HttpService = class HttpService {
    ...
    GetEmployeeById(id) {
        ...
        //const opts={id:"12"};
        //const params={id:12};
        return (this.http.get(`${this.baseUrl}employee/getParticularEmployee`, { params: params }));
    }
    getAllCountry() {
    ...
    updateEmployee(obj) {
        return (this.http.put(`${this.baseUrl}employee/updateEmployee`, obj, { responseType: 'text' }));
    }
    DeleteRecord(id) {
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]();
        params = params.append('id', id);
        return (this.http.delete(`${this.baseUrl}employee/deleteEmployee`, { params: params, responseType: 'text' }));
    }
};
...
let LoginComponent = class LoginComponent {
    ...
    onSubmit(f) {
        ...
        this.service.logincheck(obj)
            ...
            if (this.loginObj.msg == "User is not valid") {
...
module.exports = __webpack_require__(/*! D:\Front-end\Project\my-project\src\main.ts */"./src/main.ts");
