...
let FilterPipe = class FilterPipe {
    transform(value, searchTerm) {
        ...
        for (let i = 0; i < value.length; i++) { //for searching apply loop 
            let name = value[i].name; //key name 
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _shared_dialog_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../shared/dialog.service */ "./src/app/shared/dialog.service.ts");
...
let HomeComponent = class HomeComponent {
    constructor(service, title, modalservice, dialogService, toaster) {
        this.service = service;
        this.title = title;
